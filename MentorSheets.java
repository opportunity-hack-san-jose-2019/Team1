...
public class MentorSheets {
    private static List<Object> mentor = new ArrayList<Object>();
    private static Sheets sheetsService;
    private static String APPLICATION_NAME = "Sheets";
    private static String SPREADSHEET_ID = "11Y4t-ZXPPngGcutFv9rCF9GeQLxA4yVMYATv_uWpFC0";

    private static Credential authorize() throws IOException, GeneralSecurityException {
        InputStream in = MentorSheets .class.getResourceAsStream("/credentials.json");
    ...
    public static void main(String[] args) throws IOException, GeneralSecurityException {
        ...
        if (values == null || values.isEmpty()) {
            ...
            for (List row : values) {
                Object s = row.get(1);
                String str = (String) s;
                mentor.add(new Mentor((String)row.get(1),(String)row.get(12), (String)row.get(3), (String)row.get(13), (String)row.get(16), (String)row.get(15), (String)row.get(14), (String)row.get(21),(String)row.get(22),(String)row.get(23)));
...
//                }
    ...
    public static List<Object> getMentor() {
        return mentor;
    }

    public static void setMentor(List<Object> mentor) {
        MentorSheets.mentor = mentor;
    }

    public static void setSheetsService(Sheets sheetsService) {
        MentorSheets.sheetsService = sheetsService;
    }
    ...
    static class Mentor {
            ...
            public Mentor(String name, String want, String experience, String frequency, String interests, String gain, String priority,
...
//            private String convenientLocationsToMeet;
//            private String previousMentorExperience;
//            private String communities;
//            private String industryExperience;
//            private String knowledgeInSpecificArea;
//            private String importantInfoAboutSelf;
